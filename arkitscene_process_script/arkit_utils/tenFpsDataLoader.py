...
class TenFpsDataLoader(object):
    def __init__(
        ...
        if not os.path.exists(depth_folder):
            ...
            #print(depth_folder)
            self.video_id = depth_folder.split(os.sep)[-3]
        ...
        self.frame_ids = self.frame_ids[::self.frame_rate]
    ...
    def __getitem__(self, idx):
        ...
        im_height_scale = float(depth_height) / im_height
        im_width_scale = float(depth_width) / im_width
